...
public class TextDynamicBorder : MonoBehaviour 
{
  ...
  public void ButtonHandler(int index)
  {
    ...
    {
      case 0:
        Set("THIS IS A HEAD", GlobalConstants.ClothArmorDescription);
        break;

      case 1:
        Set("THIS IS A LONG LONG LONG LONG LONG LONG LONG LONG HEAD", GlobalConstants.LoremIpsum);
        break;

      case 2:
        Set("THIS IS A LONG LONG LONG LONG LONG LONG LONG LONG HEAD", GlobalConstants.PlayerGreeting);
        break;

      case 3:
        Set("THIS IS A HEAD", GlobalConstants.PlayerGreeting);
        break;

      case 4:
        Set("THIS IS A LONG LONG LONG LONG LONG LONG LONG LONG HEAD", GlobalConstants.ClothArmorDescription);
        break;

      case 5:
        Set("THIS IS A LONG LONG LONG LONG LONG LONG LONG LONG HEAD", GlobalConstants.BigTextLast);
        break;

      case 6:
        Set("THIS IS A HEAD", GlobalConstants.AxeDescription);
        break;

      case 7:
        Set("THIS IS A HEAD", GlobalConstants.ManyForcedNewlines);
        break;

      case 8:
        Set("THIS IS A LONG LONG LONG LONG LONG LONG LONG LONG HEAD", GlobalConstants.ManyForcedNewlines);
        break;

      case 9:
        Set("THIS IS A HEAD", GlobalConstants.LoremIpsum);
        break;

      case 10:
        Set("THIS IS A HEAD", GlobalConstants.BreadDescription);
        break;
  ...
  public void Set(string headText, string descriptionText)
  {
